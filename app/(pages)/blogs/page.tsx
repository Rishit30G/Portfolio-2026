...
const Blogs = () => {
  return (
    <div className='w-[1600px] mx-auto'>
        <div className='flex justify-between items-baseline  border-b border-foreground-muted/40'>
            <h1 className='text-[10rem] tracking-tighter'>Blogs</h1>
            <span className='text-3xl tracking-tighter font-mono text-foreground-muted'>006</span>
        </div>
            ...
            <div className='grid grid-cols-3 justify-items-center gap-y-20'>
                    ...
                    <div className='w-[460px] group cursor-pointer'>
                        ...
                        <div className='flex justify-between items-center mt-6'>
                            <p className='text-xl tracking-wide leading-normal uppercase font-medium'>UI/UX Design</p>
                            <p className='text-sm tracking-wide  leading-normal uppercase text-foreground-muted'>5 min read</p>
                        </div>
                        <h2 className='text-4xl tracking-tight mt-4 w-md leading-normal font-medium'>Travelling in winters.</h2>
